...
class FizzBuzzClassTest(unittest.TestCase):
    ...
    def test_fizz_2(self):
        self.assertEqual(FizzBuzz.fizz_buzz(33), 'Fizz', msg='should return `Fizz` for number divisible by 3')
    ...
    def test_fizz_buzz_2(self):
        self.assertEqual(FizzBuzz.fizz_buzz(105), 'FizzBuzz', msg='should return `FizzBuzz` for number divisible by 3 and 5')
        
    def test_indivisible_1(self):
        self.assertEqual(FizzBuzz.fizz_buzz(101), 101, msg='should return the number if its in divisible by neither 3 or 5')
